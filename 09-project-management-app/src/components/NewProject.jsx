  ...
  return (
    <>
      <Modal ref={modal}>
        ...
        <p className="text-stone-700 mb-4">Oops... looks like you forgot ot enter a value.</p>
        <p className="text-stone-700 mb-4">Please make sure you provide valid value for every input field.</p>
      </Modal>
